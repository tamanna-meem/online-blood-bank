...
<title>Blood Bank Application for IU
</title>
...
<body>
    ...
    <div class="bs-example">
      <nav style="background-color: #FF0018;" class="navbar navbar-expand-md navbar-dark fixed-top">
          <a style="color:white;" href="index.php" class="navbar-brand"><i class="fab fa-gratipay"></i>&nbsp;<font face = "Comic sans MS" size ="4">Blood Bank Application for IU
</font></a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
          ...
          <div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
              <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                      <a class="nav-link" style="color: white;" href="signin.php"  ><i class="fas fa-user"></i>  User</i></a>
                  </li>
