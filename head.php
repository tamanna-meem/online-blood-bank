...
<body>
  <div class="header">
    <a href="index.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>>Blood Bank Application for IU </a>
    ...
    <a href="about_us.php"  <?php if($active=='about') echo "class='act'"; ?> >About Us</a>
      ...
      <a href="signin.php" <?php if($active=='contact') echo "class='act'"; ?>>Login/Sign Up</a>
    </div>
  </div>
